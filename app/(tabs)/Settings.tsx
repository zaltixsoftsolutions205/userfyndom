  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case "aboutApp":
        return (
          <View style={[styles.sectionContent, { backgroundColor: theme.cardBackground }]}>
            <Text style={[styles.sectionTitle, { color: theme.text }]}>About Fyndom</Text>
            <Text style={[styles.aboutText, { color: theme.text }]}>
              Fyndom is your ultimate hostel booking platform designed to help students find the perfect hostel near their college or location.
            </Text>
            <Text style={[styles.aboutText, { color: theme.text }]}>
              🔍 Search hostels with advanced filters including price range, sharing type (1-10), amenities, food services, AC, WiFi, laundry, and more.
            </Text>
            <Text style={[styles.aboutText, { color: theme.text }]}>
              📱 Features real-time availability, verified hostels, secure payments, and student reviews. Book your stay in 3 simple steps!
            </Text>
            <Text style={[styles.aboutText, { color: theme.text, fontSize: 12, opacity: 0.8 }]}>
              Version 2.1.0 | Made with ❤️ for students
            </Text>

            <TouchableOpacity
              style={[styles.cancelBtn, { backgroundColor: theme.cancelBtn, marginTop: 20 }]}
              onPress={() => setActiveSection(null)}
            >
              <Text style={styles.cancelText}>Back</Text>
            </TouchableOpacity>
      ...
      case "privacyPolicy":
        return (
          <View style={[styles.sectionContent, { backgroundColor: theme.cardBackground }]}>
            <Text style={[styles.sectionTitle, { color: theme.text }]}>Privacy Policy</Text>
            <Text style={[styles.aboutText, { color: theme.text }]}>
              Your privacy matters at Fyndom. We collect minimal data to provide hostel search, booking, and personalized recommendations.
            </Text>
            <Text style={[styles.aboutText, { color: theme.text }]}>
              📱 What we collect: Name, email, phone, location (for nearby hostels), booking history, payment info (via secure gateway).
            </Text>
            <Text style={[styles.aboutText, { color: theme.text }]}>
              🔒 Security: All data encrypted. No sharing with third parties except payment processors. Data stored in India.
            </Text>
            <Text style={[styles.aboutText, { color: theme.text }]}>
              💬 Contact: contact@fyndom.in for privacy concerns or data deletion requests.
            </Text>
            <Text style={[styles.aboutText, { color: theme.text, fontSize: 12, opacity: 0.8 }]}>
