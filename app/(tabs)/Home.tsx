...
// import AuthService from '../../app/api/AuthService'; // Adjust path as needed
...
//   const calculatePrice = (hostel: Hostel): string => {
//     const basePrice = 4000;
//     const sharing = parseInt(hostel.facilities?.sharingTypes?.[0]?.split('-')[0]) || 2;
//     const price = basePrice + (1000 * (3 - Math.min(sharing, 3)));
//     return `₹${price} / month`;
//   };

//   const transformHostelData = (hostel: Hostel) => {
//     // Get primary photo or first photo - FIXED URL HANDLING
//     const primaryPhoto = hostel.photos?.find(photo => photo.isPrimary) || hostel.photos?.[0];

//     // Convert photo URL to absolute URL - IMPROVED HANDLING
//     let imageUrl = null;
//     if (primaryPhoto?.url) {
...
//         // Handle both formats: "/uploads/photos/..." and "uploads/photos/..."
...
//     // Convert ALL photos to absolute URLs for details page - IMPROVED
...
//     // Get sharing options from pricing - ADDED SAFETY CHECKS
//     const sharingOptions = [];

//     // Check if pricing exists and has the properties
//     if (hostel.pricing) {
...
//     // Calculate a more realistic rating based on facilities and photos
//     const baseRating = 3.5; // Start with average rating
//     let ratingBonus = 0;
...
//     // Add bonus for more facilities
//     const facilitiesCount = hostel.facilities?.essentials?.length || 0;
//     ratingBonus += Math.min(facilitiesCount * 0.1, 0.5); // Max 0.5 bonus

//     // Add bonus for AC and WiFi (popular amenities)
...
//       rating: parseFloat(finalRating.toFixed(1)), // Ensure it's a number with 1 decimal
//       image: imageUrl,
...
//     // Available beds - more availability is better
...
//                 ...item,
//                 // Add hostelOwnerId - you need to get this from your hostel data
